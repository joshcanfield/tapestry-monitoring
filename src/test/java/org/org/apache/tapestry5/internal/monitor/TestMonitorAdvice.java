package org.org.apache.tapestry5.internal.monitor;

import org.apache.tapestry5.annotations.Monitor;
import org.apache.tapestry5.internal.monitor.MonitorAdvice;
...
import static org.apache.tapestry5.annotations.Monitor.ExceptionFilter;
import static org.apache.tapestry5.annotations.Monitor.ExceptionFilter.Strategy;
...
public class TestMonitorAdvice {
    ...
    public void included_checked_exception() {
        final ExceptionFilter filter = setupCheckedExceptionTest(Strategy.Include);
    ...
    public void ignored_checked_exception() {
        final ExceptionFilter filter = setupCheckedExceptionTest(Strategy.Ignore);
    ...
    public void ignored_runtime_exception() {
        final ExceptionFilter filter = setupRuntimeExceptionTest(Strategy.Ignore);
